   ...
   public class OutInOrderFacade:IOutInOrderFacade
    {
       ...
       // OutInOrderService _service;
        ...
        public void Create(OutInOrderModel model)
        {
            ...
            entity.Code = _sequenceService.GenerateNewCode(BillIdentity.StockInOrder);           
            // 明细
            ...
            //跟踪记录
            var reason = "创建其他入库单";
            var history = new ProcessHistory(model.EditBy, model.EditByName, (int)entity.Status, entity.Id, BillIdentity.StockInOrder.ToString(), reason);
        ...
        public void Audit(int id, int editBy, string editByName)
        {
            ...
            var reason = "审核单据";
            _db.Update(entity);
            _processHistoryService.Track(entity.UpdatedBy, editByName, (int)entity.Status, entity.Id, BillIdentity.StockInOrder.ToString(), reason);
        ...
        public void Submit(int id, int editBy, string editByName)
        {
            ...
            _db.Update(entity);
            var reason = "提交单据";
            _processHistoryService.Track(editBy, editByName, (int)entity.Status, entity.Id, BillIdentity.StockInOrder.ToString(), reason);
