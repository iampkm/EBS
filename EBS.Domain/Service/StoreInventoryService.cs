        ...
        public void StockInProducts(StorePurchaseOrder entity)
        {
            ...
            foreach (var inventory in inventorys)
            {
                if (productQuantityDic.ContainsKey(inventory.ProductId))
                {
                    ...
                    inventoryUpdateModel.AvgCostPrice = Math.Round((inventory.AvgCostPrice * inventory.Quantity + purchaseOrderItem.Price * purchaseOrderItem.ActualQuantity) / totalQuantity);
